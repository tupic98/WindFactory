          ...
          <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
            <div class="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
              ...
              <div class="space-y-6 md:space-y-5">
                <div class="md:grid md:grid-cols-4 md:gap-4 md:items-start md:border-t md:border-gray-200 md:pt-5">
                  <div class="md:col-span-2 md:grid md:grid-cols-3 md:gap-4 md:items-start">
                    <label for="itype(i)" class="block text-sm font-medium text-gray-700 md:mt-px md:pt-2">
                      Type
                    </label>
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <div class="mt-1 relative rounded-md shadow-sm max-w-xs">
                        <custom-select v-model="context.form['itype(i)']" name="itype(i)" :items="context.types" :disabled="!context.form['itype(i)']" />
                      </div>
                    </div>
                  </div>
                  <div class="mt-4 md:mt-0 md:col-span-2 md:grid md:grid-cols-3 md:gap-4 md:items-start">
                    <label for="urat(r)" class="block text-sm font-medium text-gray-700 md:mt-px md:pt-2">
                      Rated Voltage
                    </label>
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <div class="mt-1 relative rounded-md shadow-sm max-w-xs">
                        <custom-input v-model="context.form['urat(r)']" type="text" name="urat(r)" id="urat(r)" :disabled="!context.form['urat(r)']" />
              ...
              <div class="space-y-6 md:space-y-5">
                <div class="md:grid md:grid-cols-4 md:gap-4 md:items-start md:border-t md:border-gray-200 md:pt-5">
                  <div class="md:col-span-2 md:grid md:grid-cols-3 md:gap-4 md:items-start">
                    <label for="irat(r)" class="block text-sm font-medium text-gray-700 md:mt-px md:pt-2">
                      Rated Current
                    </label>
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <div class="mt-1 relative rounded-md shadow-sm max-w-xs">
                        <custom-input v-model="context.form['irat(r)']" type="text" name="irat(r)" id="irat(r)" :disabled="!context.form['irat(r)']" />
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                          <span class="text-gray-500 sm:text-sm">
                            A
                          </span>
                  ...
                  <div class="mt-4 md:mt-0 md:col-span-2 md:grid md:grid-cols-3 md:gap-4 md:items-start">
                    <label for="frq(r)" class="block text-sm font-medium text-gray-700 md:mt-px md:pt-2">
                      Rated Frequency
                    </label>
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <div class="mt-1 relative rounded-md shadow-sm max-w-xs">
                        <custom-input v-model="context.form['frq(r)']" type="text" name="frq(r)" id="frq(r)" :disabled="!context.form['frq(r)']" />
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                          <span class="text-gray-500 sm:text-sm">
                            Hz
                          </span>
          ...
          <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
            <div class="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
              ...
              <div class="space-y-6 md:space-y-5">
                <div class="md:grid md:grid-cols-4 md:gap-4 md:items-start md:border-t md:border-gray-200 md:pt-5">
                  <div class="md:col-span-2 md:grid md:grid-cols-3 md:gap-4 md:items-start">
                    <label for="chartype(i)" class="block text-sm font-medium text-gray-700 md:mt-px md:pt-2">
                      Characteristic
                    </label>
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <div class="mt-1 relative rounded-md shadow-sm max-w-xs">
                        <custom-select v-model="context.form['chartype(i)']" name="chartype(i)" :items="context.characteristics" :disabled="!context.form['chartype(i)']" />
                      </div>
                    </div>
                  </div>
                </div>
...
export default class TypFuse extends Vue.with(Props) {
